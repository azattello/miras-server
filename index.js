...
// HTTPS options
const httpsOptions = {
    key: fs.readFileSync('/etc/letsencrypt/live/miras-cargo-astana.kz/privkey.pem'),
    cert: fs.readFileSync('/etc/letsencrypt/live/miras-cargo-astana.kz/fullchain.pem')
};
